        ...
        <div class="modal-dialog">
            <div class="ed-auth__modal-content modal-content">
                ...
                <div class="ed-auth__modal-head">
                    ...
                    <h3 class="ed-auth__modal-title">ඇතුල් වන්න</h3>
                    <p class="ed-auth__modal-text">
                        ගිණුමක් නිර්මාණය කළේ නැද්ද?
                ...
                <div class="ed-auth__modal-body">
                    <div class="ed-auth__modal-form">
                        <div id="SignInAlert" class="alert alert-danger d-none d-flex align-items-center" role="alert">
                            <svg class="bi flex-shrink-0 me-2" width="20" height="20" role="img" aria-label="Danger:">
                                <use xlink:href="#exclamation-triangle-fill" />
                            </svg>
                            <div id="SignInAlertMessage" class=" fs-6"></div>
                        </div>

                        <div class="form-group">
                            <input type="text" id="login_email" placeholder="විද්‍යුත් තැපෑල ඇතුලත් කරන්න" required />
                        </div>

                        <div class="form-group">
                            <input type="password" id="login_password" placeholder="මුරපදය ඇතුළත් කරන්න" required />
                        </div>
                        ...
                        <div class="ed-auth__form-btn">
                            <button class="ed-btn" onclick="SignIn();">
                                ඇතුල් වන්න<i class="fi fi-rr-arrow-small-right"></i>
                            </button>
                        </div>
                    </div>
                </div>
                        ...
                        <ul class="ed-auth__modal-third-party-list">
                            <li>
                                <a class="google-login d-flex align-items-center justify-content-center"  href="<?= $url ?>"><img 
                                        src="assets/images/icons/icon-color-google.svg" alt="icon-color-google" class="me-2" />Google හරහා ඇතුළු වන්න </a>
                            </li>
                        </ul>
                    </div>
                </div>
